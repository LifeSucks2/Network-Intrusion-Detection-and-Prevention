...
\begin{itemize}
    \item \textbf{Bandbreitensättigung:} Netzwerk oder Netzwerkkomponenten werden überlastet\bigbreak
    \item \textbf{Ressourcensättigung:} Rechner (z.B. Server) werden überlastet\bigbreak
